...
export function ConfirmationDialog({
  ...
  description,
  confirmLabel,
  cancelLabel = <DirectionText en="Cancel" ar="إلغاء" />,
  pendingLabel = <DirectionText en="Working…" ar="جارٍ التنفيذ…" />,
  onConfirm,
  destructive = false,
  isPending = false,
}: {
  ...
  return (
    <Dialog open={open} onClose={onClose} title={title} description={description}>
      <div className="flex flex-wrap justify-end gap-4 rtl:justify-start">
