...
export default function ActivityTimeline({
  ...
  return (
    <section
      className="order-2 mt-6 overflow-hidden rounded-[var(--lf-radius-card)] border border-border/80 bg-white shadow-sm"
      data-customer-activity-timeline
    >
      <div className="border-b border-border/70 bg-surface-subtle/70 px-5 py-5 sm:px-7">
      ...
      {items.length === 0 ? (
        <div className="px-5 py-12 text-center sm:px-7">
          ...
          <p className="mt-3 text-sm text-foreground-subtle">{labels.empty}</p>
        </div>
      ) : (
