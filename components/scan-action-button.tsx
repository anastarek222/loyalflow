...
export default function ScanActionButton({
  ...
  return (
    <button
      ...
      aria-busy={pending}
      className="w-full rounded-[var(--lf-radius-input)] bg-foreground px-6 py-4 font-black text-inverse transition disabled:cursor-not-allowed disabled:opacity-60"
    >
