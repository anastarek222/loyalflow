  ...
  return (
    ...
    >
      ...
      {side === "front" ? (
        <div
          dir={dir}
          className="relative grid h-full grid-cols-[minmax(0,1fr)_25%] grid-rows-[auto_1fr_auto] gap-x-[5cqw] p-[6.8cqw]"
        >
          <div
          ...
          >
            <p
              ...
              className="truncate text-[3.7cqw] font-black tracking-[0.06em]"
            >
              {props.businessName}
            </p>
            <p
              className="mt-[1cqw] text-[1.45cqw] font-bold tracking-[0.22em]"
              style={{ color: accent }}
            >
              {labels.card}
            </p>
          ...
          >
            <p
              className="text-[1.5cqw] font-bold tracking-[0.18em]"
              style={{ color: accent }}
            >
              {labels.member}
            </p>
            <p
              ...
              className="mt-[1cqw] max-w-[62%] truncate text-[4.2cqw] font-black"
            >
              {props.customerName}
            </p>
            <p
              className="mt-[2cqw] text-[1.5cqw] font-bold tracking-[0.18em]"
              style={{ color: accent }}
            >
              {labels.id}
            </p>
            <p
              dir="ltr"
              className="mt-[0.7cqw] truncate text-[2.8cqw] font-semibold tracking-[0.12em]"
            >
          ...
          <section
            ...
            className="col-span-2 mt-[3cqw] flex items-end justify-between gap-[4cqw] rounded-[2.5cqw] border border-white/20 bg-black/35 px-[3.5cqw] py-[2.7cqw] backdrop-blur-sm"
          >
            <div className="min-w-0">
              <p
                className="text-[1.4cqw] font-bold tracking-[0.16em]"
                style={{ color: accent }}
              >
                {labels.balance}
              </p>
              <p
                ...
                className="mt-[0.8cqw] truncate text-[3.7cqw] font-black"
              >
                {metrics.currentText}
              </p>
            </div>
            <div className="min-w-0 flex-1">
              ...
              <p
                ...
                className="mt-[1.2cqw] truncate text-[1.45cqw] font-bold"
              >
        ...
        <div
          dir={dir}
          className="relative flex h-full flex-col justify-between p-[6.8cqw]"
        >
          <div
          ...
          >
            <p
              dir="auto"
              title={props.businessName}
              className="truncate text-[3.4cqw] font-black tracking-[0.06em]"
            >
              {props.businessName}
            </p>
          </div>
          ...
          >
            <p
              className="text-[1.6cqw] font-bold tracking-[0.2em]"
              style={{ color: accent }}
            >
              {labels.reward}
            </p>
            <p
              ...
              className="mt-[1.8cqw] line-clamp-2 break-words text-[4.2cqw] font-black leading-tight"
            >
            ...
            <p
              ...
              aria-label={metrics.semanticRemainingText}
              title={metrics.semanticRemainingText}
              className="mt-[2cqw] truncate text-[1.8cqw] font-bold"
            >
              {metrics.remainingText}
            </p>
            ...
            <p
              ...
              className="mt-[1.4cqw] truncate text-[1.6cqw] font-semibold"
            >
              {metrics.ratioText}
            </p>
          </section>
