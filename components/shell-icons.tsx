...
import { BarChart3, Building2, CreditCard, FolderCog, Gift, GitBranch, LayoutDashboard, Megaphone, Radio, ScanLine, Settings, ShieldCheck, Tags, UserCog, Users } from "lucide-react";
...
export const icons: Record<ShellNavigationItem["icon"], ElementType> = {
  ...
  activity: Radio, program: CreditCard, rewards: Gift, offers: Tags, campaigns: Megaphone, recovery: ShieldCheck,
