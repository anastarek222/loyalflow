...
export default function AuthenticatedAppShell({
  ...
  return (
    ...
    >
      <a
        href="#app-content"
        className="sr-only z-[200] rounded-[var(--lf-radius-input)] bg-primary font-semibold text-primary-foreground focus:not-sr-only focus:fixed focus:start-4 focus:top-4 focus:px-4 focus:py-2"
      >
