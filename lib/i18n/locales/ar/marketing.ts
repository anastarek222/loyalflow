export const marketingMessagesAr = {
  ...
  "marketing.primaryCta": "ابدأ فترتك التجريبية المجانية لمدة 14 يومًا",
  "marketing.trustLine":
  ...
  "marketing.contact.body":
    "ابدأ نشاطًا جديدًا من مسار الإعداد العام، أو سجّل الدخول إلى حساب قائم.",
  "marketing.contact.setupTitle": "إعداد نشاط جديد",
  "marketing.contact.setupBody":
    "ابدأ مسار الإعداد الآمن لمساحة عمل جديدة على تاني.",
  "marketing.contact.setupCta": "ابدأ نشاطك",
  ...
  "marketing.contact.noticeBody":
    "يظل مسار ابدأ وأي رابط إعداد آمن وفريد ترسله تاني مباشرة هو المرجع الأساسي حتى اعتماد قنوات الدعم العامة.",
