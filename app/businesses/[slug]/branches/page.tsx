      ...
      <div className="mx-auto max-w-6xl">
        ...
        <header className="mb-8 mt-4 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          ...
          <div className="rounded-full bg-surface-subtle px-3 py-1.5 text-sm font-semibold text-foreground-muted">
            ...
            <strong className="ms-2 text-foreground">{getBranchCount(branches)}</strong>
          </div>
        </header>
        ...
        <details className="mb-6 rounded-[var(--lf-radius-card)] border border-border bg-surface">
          <summary className="flex min-h-14 cursor-pointer list-none items-center justify-between gap-4 px-5 py-4">
            <span>
              <span className="block text-sm font-bold text-foreground">إضافة فرع</span>
              <span className="mt-0.5 block text-xs text-foreground-subtle">اسم الفرع مطلوب، وباقي البيانات اختيارية.</span>
            </span>
        ...
        <section className="space-y-4">
          {branches.length === 0 ? (
            ...
            return (
              <article key={branch.id} className="rounded-[var(--lf-radius-card)] border border-border bg-surface p-4 sm:p-5">
                ...
                <details className="mt-4 rounded-[var(--lf-radius-input)] border border-border bg-surface-subtle">
                  <summary className="cursor-pointer list-none px-4 py-3 text-sm font-semibold text-foreground-muted">إدارة بيانات الفرع والموظفين</summary>
