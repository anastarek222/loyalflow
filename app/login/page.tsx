        ...
        <aside className="hidden flex-col justify-between p-10 lg:flex xl:p-14">
          ...
          >
            <PlatformBrandIdentity
              fallback="sparkles"
              markClassName="flex size-10 items-center justify-center rounded-xl bg-primary text-white shadow-[0_10px_24px_rgb(79_70_229/0.24)]"
          ...
          <div className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center py-10">
            <div className="mb-8 lg:hidden">
              <Link href="/" className="inline-flex items-center gap-3">
                <PlatformBrandIdentity
                  fallback="sparkles"
                  markClassName="flex size-12 items-center justify-center rounded-2xl bg-primary text-white shadow-[0_10px_24px_rgb(79_70_229/0.24)]"
                  markImageClassName="p-1"
                  wordmarkClassName="h-6 max-w-40"
