...
test("creates a fourteen-day trial window", () => {
...
test("calculates whole days remaining without dropping partial days", () => {
...
test("marks only the final trial day for reminder UX", () => {
  const trialEndsAt = new Date("2026-09-14T12:00:00.000Z");
