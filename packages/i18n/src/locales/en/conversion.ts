export const conversionMessagesEn = {
  ...
  "conversion.metaDescription":
    "Start a new Tanee business or sign in to an existing account.",
  ...
  "conversion.noSignup":
    "Already received a secure setup email? Continue only from the unique link in that message. There is no public setup-link entry point.",
