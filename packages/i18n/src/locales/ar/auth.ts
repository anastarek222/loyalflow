...
export const arabicAuthMessages = {
  ...
  "auth.setupMfaPageBody":
    "المصادقة متعددة العوامل مطلوبة لدخول المشرف العام. تحقق من حسابك، وأضف LoyalFlow إلى تطبيق المصادقة، واحفظ رموز الاسترداد أحادية الاستخدام.",
  ...
  "auth.mfaAddAuthenticator": "أضف LoyalFlow إلى تطبيق المصادقة",
