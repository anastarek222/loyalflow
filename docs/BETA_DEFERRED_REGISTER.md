...
be proven with isolated synthetic/internal evidence. TC3 Blob Staging lifecycle
is verified. The next independent named slice is the measured disposable
database restore rehearsal; it must fork only from isolated Staging, verify
integrity/timing, clean up the disposable branch, and must not touch Production.
