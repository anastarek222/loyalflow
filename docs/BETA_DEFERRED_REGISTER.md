...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| TC3 Custom Card    | Vercel Blob Beta lifecycle plus isolated-Staging activation/UAT: private isolated upload, immutable version, authenticated draft preview, explicit publish, token-bound desktop/mobile front/back delivery, and Standard-mode cleanup | retention/deletion policy beyond the current preserve-all Beta rule; any Production resource, token, or activation | explicit retention/deletion decision and separate Production authorization |
