...
These three slices no longer require business-logic extraction. Each has an isolated command-backed Server Action with passing GitHub TC/TR evidence. Their remaining code step is the Customer-detail page/form binding followed by final-head TR.
