...
T004 must not be marked complete while Independent Reviewer remains `UNASSIGNED` if independent review is retained as a mandatory closeout requirement. A governance exception for another task does not automatically waive this requirement for T004.
