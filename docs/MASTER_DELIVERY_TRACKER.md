...
The next executable T007 step is **run the governed 5-10 business Closed Beta using anonymous participant IDs and the approved operating record, then record the explicit human Go/No-Go decision**. Production execution remains forbidden. T008 remains blocked until this T007 exit evidence exists.
