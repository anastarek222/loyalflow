...
| P6 API foundation | In progress locally | same-origin BFF, current Vercel hosting, NextAuth identity, and `/api/v1` decisions are approved; first read-only envelope/version/liveness slice awaits PR evidence. |
